...
public class Environment {
   ...
   public void introduction(int thread) throws InterruptedException {
      ...
      String[] introStrings = { "       -= most humble fisherman who lives by the sea =-  \n",
   ...
   public void ending1(int thread) throws InterruptedException {
      String[] noLuckEnding = { "Humble fisherman,", " the day is now over.\n",
      ...
      System.out.println("  -= Perhaps tomorrow will bring a different kind " + "of fortune? =-");
      return;
   }
   ...
   public void ending3(int thread) throws InterruptedException {
      ...
      Thread.sleep(thread * 2);
      String[] lureEnding2 = { "We shall see...\n", "But for now what I will grant you is this: \n",
            "You will grow to be very old,", " and very wise \n", "You will neither be rich", " nor poor. \n",
            "You will continue to work hard", " and be humble \n", "but you will be happy",
      ...
      if (release) {
         ...
         String[] releasedStrings = { "\nYou release the magical fish into the ocean.\n",
               ...
               "You look out at the ocean, take in it’s infinite majesty, pack " + "your\n"
