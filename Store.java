 ...
 * Date: 4/23/2017
 *
 * Class Store represents a store that buys fish, sells a fishing pole, a
 * fishing lure, and a boat for the game HumbleFisherman.
 *******************************************/
...
public class Store {
   ...
   private String[] storeDescriptors = { "\n\n    ><(*>  WELCOME TO THE FISHING STORE!!!  <*)><\n",
         "!!! Let us give you $$$ for your catch !!!", "!!! Catch heaviest fish with a NICE FISHING POLE for $25 !!!",
